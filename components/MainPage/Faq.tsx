...
export default function Faq() {
  ...
  const QA = [
    ...
    { question: 'Can I see again previously generated images?', answer: `At the moment, the feature for viewing past images is not yet available, but we are working to implement it soon. Rest assured, your last 15 images are securely stored in our database and will be accessible in the near future. Should you require access to a specific image, please don't hesitate to reach out to us via Twitter and we will be more than happy to provide it for you.`},
