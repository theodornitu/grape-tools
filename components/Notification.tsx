...
const explorerLink = process.env.NEXT_PUBLIC_NETWORK_EXPLORER_ADDRESS + "/transactions/";
                ...
                <div className="p-4">
                    <div className="flex items-start">
                        ...
                        <div className="ml-3 w-0 flex-1 pt-0.5">
                            ...
                            <a  href={explorerLink+body}

                                target="_blank" 
                                rel="noopener noreferrer" 
                            >
                                    <FaSearch className="-mt-0.5 hover:cursor-pointer hover:text-violet-600"/>
                                </a>
                            </p>
                        </div>
